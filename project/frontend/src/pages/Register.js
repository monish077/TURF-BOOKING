          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 mb-8 leading-relaxed">
                Your account was created successfully. Please check your email and click the verification link to activate your account.
              </p>
              <button
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-[#0d1520] border border-white/10 rounded-xl py-3.5 pl-12 pr-4 text-white focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all appearance-none cursor-pointer"
                >
